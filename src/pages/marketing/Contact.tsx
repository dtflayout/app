      ...
      <div style={{ position: "fixed", top: 16, left: 0, right: 0, zIndex: 100, padding: "0 32px" }}>
        <nav style={{ maxWidth: 960, margin: "0 auto", background: "linear-gradient(135deg, #1E1B4B, #252272, #1E1B4B)", borderRadius: 16, padding: "0 8px 0 24px", height: 56, display: "flex", alignItems: "center", justifyContent: "space-between", border: "1px solid rgba(99, 102, 241, 0.2)", boxShadow: "0 8px 32px rgba(15,13,46,0.5), 0 2px 8px rgba(0,0,0,0.2)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            {[{ l: "Pricing", to: "/pricing" }, { l: "FAQ", to: "/faq" }, { l: "Contact", to: "/contact" }].map(item => <Link key={item.l} to={item.to} style={{ fontSize: 14, fontWeight: 500, color: item.l === "Contact" ? "#fff" : "rgba(255,255,255,0.7)", padding: "8px 14px", textDecoration: "none" }}>{item.l}</Link>)}
          </div>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14 }}>
            {[
              ...
              { title: "Website Integration", desc: "Embedding, Shopify, white-labeling", to: "/faq", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10" /><line x1="2" y1="12" x2="22" y2="12" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10A15.3 15.3 0 0 1 12 2z" /></svg>, tint: "linear-gradient(135deg, #ECFDF5, #D1FAE5)", accent: "#059669" },
