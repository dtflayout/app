...
const FAQS = [
  ...
  { q: "Do you offer refunds?", a: "Credits are non-refundable once purchased — they never expire, so you can use them at your own pace. We do issue refunds in a few specific situations: duplicate charges, billing errors on our side, or a verified technical failure reported within 7 days of purchase if no credits have been used. See our Refund Policy for full details." },
    ...
    <div style={{ fontFamily: BF, color: "#111827", background: "#FAFAFB", overflowX: "hidden" }}>
      ...
      <section style={{ padding: isMobile ? "10px 16px 0" : "10px 40px 0", position: "relative" }}>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(4, 1fr)", gap: 20, alignItems: "start" }}>
            {PLANS.map((plan) => {
        ...
        <div style={{ maxWidth: 940, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 24 }}>
            <div style={{ background: "linear-gradient(135deg, #1E1B4B, #312E81)", borderRadius: 20, padding: "32px 32px 28px", color: "#fff" }}>
              <div style={{ display: "flex", alignItems: "center", marginBottom: 24 }}><img src="/DTF-Layout-WHITE-logo-text.png" alt="DTF Layout" style={{ height: 38, width: "auto", display: "block" }} /></div>
              {[["Pricing model","Credits (one-time buy)"],["Monthly fees","None, ever"],["Per-order cut","None"],["Standalone store","Quick Store included"],["Platform support","Any website"],["White-label builder","Full customization"],["Image enhancer","Included"],["Text editor","Included"],["Multi-sheet export","Up to 5 sheets"]].map(([f,v],i) => (
                <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "15px 0", borderBottom: i < 8 ? "1px solid rgba(255,255,255,0.08)" : "none" }}>
            ...
            <div style={{ background: "#FAFAFA", borderRadius: 20, border: "1px solid #E5E7EB", padding: "32px 32px 28px" }}>
              ...
              {[["Pricing model","5% per order or $149–999/mo",true],["Monthly fees","$0–999/month",true],["Per-order cut","Up to $12/order",true],["Standalone store","Not available",true],["Platform support","Shopify / WooCommerce only",true],["White-label builder","Logo only or limited",true],["Image enhancer","Not available",true],["Text editor","Limited or unavailable",true],["Multi-sheet export","Available",false]].map(([f,v,bad],i) => (
                <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "15px 0", borderBottom: i < 8 ? "1px solid #F3F4F6" : "none" }}>
