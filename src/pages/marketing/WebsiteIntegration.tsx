...
export default function WebsiteIntegration() {
  ...
  return (
    <div style={{ fontFamily: BF, color: "#111827", overflowX: "hidden" }}>
      ...
      {/* HERO */}
      <section style={{ position: "relative", overflow: "hidden", background: "linear-gradient(180deg, #0A0820 0%, #0F0D2E 12%, #1E1B4B 24%, #312E81 36%, #4F46E5 48%, #6366F1 55%, #818CF8 62%, #A5B4FC 68%, #C7D2FE 74%, #E0E7FF 80%, #EEF2FF 86%, #F5F5F7 92%, #FAFAFB 100%)", padding: isMobile ? "0 16px 0" : "0 40px 0" }}>
        ...
        <div style={{ padding: isMobile ? "100px 0 0" : "140px 0 0" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
            ...
            <h1 style={{ fontFamily: HF, fontSize: isMobile ? 56 : 60, fontWeight: 800, color: "#fff", lineHeight: 1.08, letterSpacing: "-0.03em", margin: "28px 0 20px" }}>Your Brand. Your Builder.<br />Your Website.</h1>
      ...
      <section style={{ padding: isMobile ? "60px 16px" : "120px 40px", position: "relative" }}><Dots o={0.08} /><Sq top={80} right={120} size={32} rotate={18} /><Sq bottom={90} left={100} size={24} rotate={-15} /><div style={{ maxWidth: 1060, margin: "0 auto", position: "relative", zIndex: 1 }}><div style={{ textAlign: "center", marginBottom: 64 }}><Pill>Quick Setup</Pill><h2 style={{ fontFamily: HF, fontSize: isMobile ? 26 : 44, fontWeight: 800, color: "#111827", lineHeight: 1.1, letterSpacing: "-0.03em", margin: "20px 0 12px" }}>Live on Your Website in 3 Steps</h2><p style={{ fontSize: 16, color: "#6B7280", lineHeight: 1.7, maxWidth: 520, margin: "0 auto" }}>No coding. No plugins. Just a link you can embed anywhere.</p></div>
        {/* Step 1 */}
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1.2fr", gap: 32, marginBottom: 72, alignItems: "center" }}>
        ...
        {/* Step 2 */}
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.2fr 1fr", gap: 32, marginBottom: 72, alignItems: "center" }}>
      ...
      <section style={{ padding: isMobile ? "60px 16px" : "120px 40px", background: "#FAFAFB", position: "relative" }}><Dots o={0.06} /><div style={{ maxWidth: 1060, margin: "0 auto", position: "relative", zIndex: 1 }}><div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1.15fr", gap: 48, alignItems: "stretch" }}>
        <div style={{ display: "flex", flexDirection: "column" }}><Pill>Full White-Labeling</Pill><h2 style={{ fontFamily: HF, fontSize: isMobile ? 26 : 40, fontWeight: 800, color: "#111827", lineHeight: 1.1, letterSpacing: "-0.03em", margin: "20px 0 12px" }}>Your Brand, Down to Every Pixel</h2><p style={{ fontSize: 15, color: "#6B7280", lineHeight: 1.7, margin: "0 0 36px" }}>Customize every visual element so the builder feels native to your site. Your customers never see our brand.</p>
      ...
      {/* INTERACTIVE DEMO */}
      <section style={{ padding: isMobile ? "60px 16px" : "100px 40px", position: "relative" }}>
        <Dots o={0.06} />
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ borderRadius: 28, overflow: "hidden", background: "linear-gradient(140deg, #0f0d2e 0%, #1e1b4b 30%, #312e81 60%, #4338ca 100%)", boxShadow: "0 16px 56px rgba(30,27,75,0.35)", position: "relative" }}>
            ...
            <div style={{ padding: isMobile ? "32px 24px" : "48px 48px", display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: "center", gap: isMobile ? 24 : 40, position: "relative", zIndex: 1 }}>
              <div style={{ flex: 1 }}>
              ...
              {!isMobile && <div style={{ flex: "0 0 auto", width: 260, height: 200, borderRadius: 16, background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", display: "flex", flexDirection: "column", overflow: "hidden" }}>
                <div style={{ padding: "6px 10px", background: "#1e293b", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 5 }}><div style={{ width: 16, height: 16, borderRadius: 4, background: "rgba(79,70,229,0.3)" }} /><span style={{ fontSize: 8, fontWeight: 700, color: "#fff" }}>Your Brand</span></div>
                ...
                <div style={{ flex: 1, background: "#f1f5f9", padding: "8px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 6 }}>
                  <div style={{ display: "flex", gap: 4 }}>{["#4F46E5", "#0EA5E9", "#A855F7", "#F59E0B"].map((c, i) => <div key={i} style={{ width: 18, height: 18, borderRadius: "50%", background: c }} />)}</div>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 3, width: "80%" }}>{[1, 2, 3].map(i => <div key={i} style={{ height: 24, borderRadius: 3, background: "#fff", border: "1px solid #E5E7EB" }} />)}</div>
      ...
      <section style={{ padding: isMobile ? "60px 16px" : "120px 40px", position: "relative" }}><Dots o={0.06} /><div style={{ maxWidth: 1060, margin: "0 auto", position: "relative", zIndex: 1 }}><div style={{ textAlign: "center", marginBottom: 64 }}><Pill>Automated Variant Matching</Pill><h2 style={{ fontFamily: HF, fontSize: isMobile ? 26 : 44, fontWeight: 800, color: "#111827", lineHeight: 1.1, letterSpacing: "-0.03em", margin: "20px 0 12px" }}>Height-Based Pricing, Automated</h2><p style={{ fontSize: 16, color: "#6B7280", lineHeight: 1.7, maxWidth: 560, margin: "0 auto" }}>Map your product variants to sheet heights. When a customer generates a sheet, we auto-match the right variant and price.</p></div>
      ...
      {/* ORDER DASHBOARD */}
      <section style={{ padding: isMobile ? "60px 16px" : "120px 40px", background: "#FAFAFB", position: "relative" }}><Dots o={0.06} /><div style={{ maxWidth: 1060, margin: "0 auto", position: "relative", zIndex: 1 }}><div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.2fr 1fr", gap: 48, alignItems: "center" }}>
        <div style={{ borderRadius: 20, overflow: "hidden", border: "1px solid #E5E7EB", boxShadow: "0 16px 48px rgba(0,0,0,0.06)", background: "#fff" }}>
          ...
          {/* Kanban */}
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1fr", gap: 8, padding: "0 12px 14px" }}>
        ...
        <div><Pill>Order Management</Pill><h2 style={{ fontFamily: HF, fontSize: isMobile ? 26 : 40, fontWeight: 800, color: "#111827", lineHeight: 1.1, letterSpacing: "-0.03em", margin: "20px 0 12px" }}>Track Every Order, Drag to Fulfill</h2><p style={{ fontSize: 15, color: "#6B7280", lineHeight: 1.7, margin: "0 0 32px" }}>A Kanban board built for DTF workflows. Drag orders from Pending to Paid, download gang sheet files, and track everything with stats and filters.</p>
      ...
      <section style={{ padding: isMobile ? "60px 16px" : "120px 40px", background: "linear-gradient(180deg, #0F0D2E, #1E1B4B, #312E81)", position: "relative", overflow: "hidden" }}><MovingPattern /><div style={{ maxWidth: 1060, margin: "0 auto", position: "relative", zIndex: 1 }}><div style={{ textAlign: "center", marginBottom: 64 }}><Pill>Why Switch?</Pill><h2 style={{ fontFamily: HF, fontSize: isMobile ? 26 : 44, fontWeight: 800, color: "#fff", lineHeight: 1.1, letterSpacing: "-0.03em", margin: "20px 0 12px" }}>Stop Losing Customers to Manual Workflows</h2><p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", lineHeight: 1.7, maxWidth: 540, margin: "0 auto" }}>Every customer who has to email you a file is a customer who might not come back.</p></div>
