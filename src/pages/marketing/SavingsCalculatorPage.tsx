...
export default function SavingsCalculatorPage() {
  ...
  return (
    <div style={{ fontFamily: BF, color: "#111827", background: "#FAFAFB" }}>
      ...
      {/* ═══ HERO ═══ */}
      <section style={{ position: "relative", overflow: "hidden", background: "linear-gradient(180deg, #0A0820 0%, #0A0820 8%, #0F0D2E 18%, #1E1B4B 32%, #312E81 46%, #4F46E5 60%, #6366F1 70%, #818CF8 78%, #C7D2FE 86%, #FAFAFB 96%)", padding: "0 40px 0", minHeight: "50vh" }}>
        ...
        <div style={{ padding: "160px 0 80px" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
            ...
            <h1 style={{ fontFamily: HF, fontSize: 56, fontWeight: 800, color: "#fff", lineHeight: 1.08, letterSpacing: "-0.03em", margin: "28px 0 20px" }}>
              See How Much You'll Save<br />Switching to DTF Layout
            </h1>
            <p style={{ fontSize: 18, color: "rgba(255,255,255,0.8)", lineHeight: 1.7, maxWidth: 540, margin: "0 auto 20px" }}>
              Compare your current platform costs with DTF Layout. Fill in 3 details below — your savings update instantly.
            </p>
            <p style={{ fontFamily: HF, fontSize: 16, fontWeight: 700, color: "rgba(255,255,255,0.9)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, alignItems: "end" }}>
              <div>
                ...
                <select className="sc3-sel" value={width} onChange={e => { setWidth(Number(e.target.value)); trackCalcChange("width_change", { width: e.target.value }); }} style={calcSel}>
                  {CALC_WIDTHS.map(w => <option key={w} value={w}>{w}" wide</option>)}
                </select>
              </div>
              <div>
            ...
            <div style={{ padding: "14px 20px 10px", borderRadius: 18, background: "linear-gradient(135deg, #F5F3FF, #EDE9FE)", border: "1.5px solid #DDD6FE", boxShadow: "0 4px 16px rgba(124,58,237,0.06)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, color: "#7C3AED", fontWeight: 500, marginTop: 1, lineHeight: 1.3 }}>Each sheet is assumed 100" in length</div>
                </div>
              </div>
      ...
      <section style={{ padding: "60px 40px 120px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          <h2 style={{ fontFamily: HF, fontSize: 40, fontWeight: 800, color: "#111827", lineHeight: 1.1, letterSpacing: "-0.03em", margin: "0 0 14px" }}>Ready to Start Saving?</h2>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 14, marginBottom: 20 }}>
            <Btn sz="l" onClick={() => handleCTA("bottom_start_free", "/signup")}>Start Free →</Btn>
            <Btn v="o" sz="l" onClick={() => handleCTA("bottom_see_demo", "/demo/website-integration")}>See Demo →</Btn>
          </div>
          <div style={{ display: "flex", justifyContent: "center", gap: 28 }}>
            {["No credit card", "All tools included", "No per-order cuts"].map((t, i) => (
              <span key={i} style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 14, color: "#4B5563", fontWeight: 500 }}>
