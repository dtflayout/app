    ...
    <div style={{ fontFamily: BF, color: "#111827", overflowX: "hidden" }}>
      ...
      <section style={{ padding: "100px 40px", position: "relative" }}><Dots o={0.06} /><div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ borderRadius: 24, overflow: "hidden", border: "1px solid #E5E7EB", boxShadow: "0 4px 24px rgba(0,0,0,0.04)" }}>
          ...
          {[{f:"Pricing Model",d:"One-time credits",dr:"5% per order",k:"$149–499/mo"},{f:"Per-Order Cut",d:"None",dr:"Up to $12",k:"5% (Basic)"},{f:"Platform Support",d:"Any website",dr:"Shopify only",k:"Shopify/Woo"},{f:"White-Label",d:"Full (8 zones)",dr:"Logo only",k:"Limited"},{f:"Background Remover",d:"Included",dr:"Paid add-on",k:"Not available"},{f:"Quick Store",d:"Included free",dr:"Not available",k:"Not available"}].map((r,i)=>(
            <div key={i} style={{ display:"grid",gridTemplateColumns:"1.5fr 1fr 1fr 1fr",borderBottom:i<5?"1px solid #F3F4F6":"none",background:"#fff" }}><div style={{ padding:"14px 24px",fontSize:14,fontWeight:600,color:"#374151" }}>{r.f}</div><div style={{ padding:"14px",textAlign:"center",fontSize:13,fontWeight:600,color:"#059669",display:"flex",alignItems:"center",justifyContent:"center",gap:4 }}><svg width="12" height="12" viewBox="0 0 12 12"><path d="M2.5 6l2.5 2.5 4.5-4.5" stroke="#10B981" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/></svg>{r.d}</div><div style={{ padding:"14px",textAlign:"center",fontSize:13,color:"#6B7280" }}>{r.dr}</div><div style={{ padding:"14px",textAlign:"center",fontSize:13,color:"#6B7280" }}>{r.k}</div></div>))}
        </div>
