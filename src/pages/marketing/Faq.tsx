...
const getFaqSections = (region: 'india' | 'global'): FaqSection[] => [
  {
    ...
    items: [
      ...
      { q: "What's the difference between the Gang Sheet Builder, Website Integration, and Quick Store?", a: (<div><p style={{ marginBottom: 12 }}>These are three different ways to use DTF Layout, all included in every plan:</p><ul style={{ margin: 0, paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}><li><strong>Gang Sheet Builder</strong> — The core tool. You (the printer) log in, upload images, edit them, and generate optimized gang sheets for your own use.</li><li><strong>Website Integration</strong> — Embed a fully white-labeled gang sheet builder on your existing website (Shopify, WooCommerce, or any platform). Your customers create their own sheets, pick a variant, and check out through your store. You receive the order + print-ready file.</li><li><strong>Quick Store</strong> — A complete standalone storefront hosted by DTF Layout (yourname.dtflayout.com). No website needed. Your customers browse products, create gang sheets, and place orders directly — all under your brand.</li></ul></div>) },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How does the variant matching work?", a: "You paste your product URL (works with Shopify and other platforms), and DTF Layout auto-fetches all variants (e.g., 22×20, 22×30, 22×40) with their prices. When a customer generates a gang sheet, we auto-match the closest variant based on the sheet height and redirect them to your store's cart with the correct variant pre-selected. The customer pays through your normal checkout — you keep 100% of the payment." },
      ...
      { q: "Which website platforms are supported?", a: "Website Integration works with any platform. The builder URL can be embedded via iframe on Shopify, WooCommerce, WordPress, Wix, Squarespace, or any custom-built site. Variant auto-fetching currently works best with Shopify, with more platforms coming soon. You can always add variants manually regardless of your platform." },
  ...
  },
  {
    ...
    items: [
      { q: "What is Quick Store?", a: "Quick Store is a complete standalone storefront hosted by DTF Layout at yourname.dtflayout.com. If you don't have a website or prefer a dedicated ordering page, Quick Store gives you a fully branded online store where customers can browse your products, create gang sheets, and place orders — all without you writing a single line of code." },
      { q: "How is Quick Store different from Website Integration?", a: (<div><ul style={{ margin: 0, paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}><li><strong>Website Integration</strong> — You embed the gang sheet builder on your existing website. Checkout happens through your store. Best for printers who already have a website on any platform.</li><li><strong>Quick Store</strong> — A full standalone storefront hosted by us. Customers browse products, create gang sheets, and submit orders — all on your Quick Store URL. Best for printers who don't have a website or want a dedicated ordering page.</li></ul></div>) },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do I need a specific website platform to use DTF Layout?", a: "No. Website Integration works with any platform — Shopify, WooCommerce, WordPress, Wix, Squarespace, or any custom-built site. Just embed the builder URL via iframe or share it as a direct link. And Quick Store gives you a complete standalone storefront without needing any external platform at all — no website required." },
      { q: "I already have a website. How hard is it to set up?", a: "Very easy. You don't need to install anything or migrate data. Just create your store in DTF Layout, paste your product URL (we auto-fetch variants for Shopify stores), customize the look, and embed the builder on your website. Your existing products, variants, and checkout flow stay exactly the same — DTF Layout simply provides the gang sheet builder that connects to your store." },
