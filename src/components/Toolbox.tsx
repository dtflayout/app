...
const tools: Tool[] = [
  {
    id: "trim",
    label: "Trim",
    icon: <Scissors className="w-5 h-5" strokeWidth={2.5} />,
  ...
  },
  {
    id: "flip-rotate",
    label: "Flip / Rotate",
    icon: <RotateCw className="w-5 h-5" strokeWidth={2.5} />,
  ...
  },
  {
    id: "remove-bg",
    label: "Remove Color",
    icon: <Pipette className="w-5 h-5" strokeWidth={2.5} />,
  ...
  },
  {
    id: "replace-color",
    label: "Replace Color",
    icon: <Replace className="w-5 h-5" strokeWidth={2.5} />,
  ...
  },
  {
    id: "create",
    label: "Coming Soon",
    icon: <Circle className="w-5 h-5" strokeWidth={1.5} />,
    bgColor: "bg-gray-200",
    enabled: false,
    comingSoon: true,
  },
            ...
            <Tooltip key={tool.id}>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <div
                    className={`
                      w-[3.25rem] h-[3.25rem] rounded-full flex items-center justify-center
                  ...
                  <span
                    className={`
                      text-xs font-medium transition-all duration-300 whitespace-pre-line leading-tight text-center
                      ${isDisabled 
