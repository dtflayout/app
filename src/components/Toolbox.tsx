...
const tools: Tool[] = [
  {
    id: "trim",
    label: "Trim",
    icon: <Scissors className="w-7 h-7" strokeWidth={2.5} />,
  ...
  },
  {
    id: "flip-rotate",
    label: "Flip / Rotate",
    icon: <RotateCw className="w-7 h-7" strokeWidth={2.5} />,
  ...
  },
  {
    id: "remove-bg",
    label: "Remove Color",
    icon: <Pipette className="w-7 h-7" strokeWidth={2.5} />,
  ...
  },
  {
    id: "replace-color",
    label: "Replace Color",
    icon: <Replace className="w-7 h-7" strokeWidth={2.5} />,
  ...
  },
  {
    id: "type-text",
    label: "Type Text",
    icon: <Type className="w-7 h-7" strokeWidth={2.5} />,
    bgColor: "bg-indigo-500 hover:bg-indigo-600",
    enabled: true,
  },
  {
  ...
  },
  {
    id: "create",
    label: "Coming Soon",
    icon: <Circle className="w-7 h-7" strokeWidth={1.5} />,
    bgColor: "bg-gray-200",
    enabled: false,
    comingSoon: true,
  },
            ...
            <Tooltip key={tool.id}>
              <TooltipTrigger asChild>
                <button
                  ...
                  disabled={isDisabled}
                  className={`
                    flex flex-col items-center gap-2.5 group transition-all duration-300
                ...
                >
                  ...
                  <div
                    className={`
                      ...
                      ${isDisabled 
                        ...
                        : iconColor 
                          ? "text-white hover:scale-110 hover:shadow-xl hover:-translate-y-1 active:scale-95"
                          : `${tool.bgColor} text-white hover:scale-110 hover:shadow-xl hover:-translate-y-1 active:scale-95`
                      }
                    `}
                  ...
                  <span
                    className={`
                      text-sm font-semibold transition-all duration-300 whitespace-pre-line leading-tight text-center
                      ${isDisabled 
