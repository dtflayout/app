  ...
  const getWarningConfig = () => {
    ...
    if (credits <= 2300) {
      return {
        ...
        message: `Only ${credits.toLocaleString('en-IN')} sq.in remaining. Purchase more to continue.`,
        buttonText: "Buy Credits Now",
        buttonClass: "bg-red-600 hover:bg-red-700 text-white",
        canDismiss: false,
      };
    ...
    if (credits < 6900) {
      return {
        ...
        message: `You have ${credits.toLocaleString('en-IN')} sq.in remaining. Consider purchasing more soon.`,
