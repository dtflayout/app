...
export const FloatingLayoutBar: React.FC<FloatingLayoutBarProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center pb-4 px-4 pointer-events-none animate-slide-up">
      ...
      <div 
        className={`w-[80%] rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.3)] pointer-events-auto border ${barColor ? 'border-white/10' : 'bg-gradient-dark border-indigo-500/20'}`}
        ...
        <div className="px-6 py-3">
          <div className="flex items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-3">
              <Label className="text-sm font-medium text-white/70 whitespace-nowrap flex items-center gap-1.5">
                Sheet Width
              ...
              {widthReadOnly ? (
                <div className="w-[180px] h-10 rounded-lg bg-white/15 text-white border border-white/20 shadow-lg text-sm font-semibold flex items-center justify-center gap-2">
                ...
                >
                  <SelectTrigger className="w-[180px] h-10 rounded-lg bg-white/15 text-white border-white/20 shadow-lg text-sm font-semibold hover:bg-white/25 transition-all duration-200 [&>svg]:text-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="w-[80px] h-10 px-3 rounded-lg border border-gray-200 bg-white text-gray-800 text-sm font-medium shadow-sm hover:border-gray-400 transition-colors focus:ring-2 focus:ring-white/50 focus:border-white/50"
              />
            </div>
              ...
              >
                <span>
                  <Button
                    ...
                    disabled={!canPreview}
                    variant="outline"
                    className={`h-10 px-5 rounded-lg border-2 font-semibold transition-all duration-200 ${
                      canPreview 
                  ...
                  >
                    <Eye className={`mr-2 h-4 w-4 ${canPreview ? "text-white" : "text-white/30"}`} />
                    Preview
                  </Button>
                </span>
              </MobileTooltip>
